...
Digite, por exemplo, a seguinte URL no Firefox:
    http://www.omdbapi.com/?s=star%20wars&apikey=5a772a77

Observe que vemos uma lista de 10 filmes, mas há mais resultados.

Para ver a página 2, acesse
    http://www.omdbapi.com/?s=star%20wars&page=2&apikey=5a772a77
'''


'''
Observe que nas URLs acima, estamos passando parâmetros.
Na URL http://www.omdbapi.com/?s=star%20wars&page=2&apikey=5a772a77
...
Resposta: total Results 848, nessa query, 10
...
Resposta: basta adicionar &type=movie, sao 600 resultados(apenas filmes),
...
def busca_filmes(texto_buscar):
    ...
    lista = []
    for filme in json['Search']:
        dic = {'nome': filme['Title'], 'ano': filme['Year']}
        lista.append(dic)
    return lista
